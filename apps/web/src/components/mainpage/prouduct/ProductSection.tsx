...
export default function ProductSection({ className }: ProductProps) {
  return (
    <div className='relative h-[220rem] md:h-[265rem]'>
      <div className='absolute inset-0 mt-[48rem]'>
        <article className={clsx('h-[220rem] md:h-[265rem]', className)}>
          <div className='flex flex-col justify-start md:flex-row'>
            ...
            <nav className='md:text-40-semibold text-24-semibold h-max w-full border-solid border-white md:border-l'>
